...
# 예시 사용법
system_msg = """당신은 도움을 주는 한국어 어시스턴트입니다.
            답변을 하기 이전, 한 번 주의깊게 생각을 하고 답을 말해주세요.이 과정은 매우 중요합니다. 
            사용자의 입력한 메시지를 확인한 후 각 문단별 주장, 근거, 요약을, Json형태로 전달할 수 있어야 합니다.
            문단은 줄나눔이 된 것을 기준으로 합니다.
            주어진 토큰 길이 안에서 문장을 끝맺음할 수 있어야 합니다.
            출력 예시는 다음과 같습니다.
...
response = generate_response(system_msg, user_msg, model="gpt-3.5-turbo", max_tokens=1024, temperature=0.7, top_p=1, n=1, stream=False, stop=None, presence_penalty=0, frequency_penalty=0, logit_bias=None, user=None)
print(response)
